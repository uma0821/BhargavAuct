          ...
          <div className="row gy-5 row-cols-xxl-6 row-cols-xl-5 row-cols-md-4 row-cols-sm-3 row-cols-2">
            ...
            >
              <div className="category-card">
                <Link
                  href="/multipurpose2/auction-sidebar"
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">
                      Automotive
                    </Link>
                  </h5>
            ...
            >
              <div className="category-card">
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">Antiques</Link>
                  </h5>
            ...
            >
              <div className="category-card">
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">Old Coin</Link>
                  </h5>
            ...
            >
              <div className="category-card">
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">Gadget</Link>
                  </h5>
            ...
            >
              <div className="category-card">
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">Jewelry</Link>
                  </h5>
            ...
            >
              <div className="category-card">
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">Fashion</Link>
                  </h5>
                  <span>41,250 Item</span>
                </div>
              </div>
            ...
            >
              <div className="category-card">
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">Ceramics</Link>
                  </h5>
            ...
            >
              <div className="category-card">
                ...
                <div className="category-content">
                  <h5>
                    <Link href="/multipurpose2/auction-sidebar">Gadgets</Link>
                  </h5>
