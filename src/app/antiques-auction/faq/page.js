              ...
              <div className="faq-contact-wrap two">
                <div className="faq-nav-btn-area">
                  <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    <button className="nav-link active" id="general-tab" data-bs-toggle="pill" data-bs-target="#general" type="button" role="tab" aria-controls="general" aria-selected="true">General</button>
                    <button className="nav-link" id="payment-tab" data-bs-toggle="pill" data-bs-target="#payment" type="button" role="tab" aria-controls="payment" aria-selected="false">Payment</button>
                    <button className="nav-link" id="bidding-tab" data-bs-toggle="pill" data-bs-target="#bidding" type="button" role="tab" aria-controls="bidding" aria-selected="false">Bidding</button>
                  </div>
                </div>
                <div className="contact-address-area">
                  ...
                  <div className="contact-area">
                    ...
                    <div className="content">
                      ...
                      <h5><a href="mailto:info@gmail.com">info@gmail.com</a></h5>
                    </div>
                  </div>
                </div>
              </div>
            </div>
            <div className="col-lg-9 wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="tab-content" id="v-pills-tabContent">
                <div className="tab-pane fade show active" id="general" role="tabpanel" aria-labelledby="general-tab" tabIndex={0}>
                    ...
                    <div className="faq-content">
                      <div className="accordion" id="accordionGeneral">
                        ...
                        <div className="accordion-item">
                          ...
                          <div id="faqcollapseSix" className="accordion-collapse collapse" aria-labelledby="faqheadingSix" data-bs-parent="#accordionGeneral">
                            <div className="accordion-body">
                              Yes, you can sell items at auctions. Register with the auction house or platform, provide item details, and agree to the terms, including fees and commissions. This process can help you reach a wide audience and achieve competitive prices.
                            </div>
                          </div>
                        </div>
                        <div className="accordion-item">
                          ...
                          <div id="faqcollapseSeven" className="accordion-collapse collapse" aria-labelledby="faqheadingSeven" data-bs-parent="#accordionGeneral">
                            <div className="accordion-body">
                              No, buying at auctions can be advantageous. You can find unique items, often at lower prices than retail. Auctions also offer a transparent buying process and the excitement of competitive bidding. With proper research and budgeting, auctions can be a rewarding way to purchase valuable and rare items.
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="tab-pane fade" id="payment" role="tabpanel" aria-labelledby="payment-tab" tabIndex={0}>
                  <div className="faq-wrappper">
                    <div className="faq-content">
                      <div className="accordion" id="accordionPayment">
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingPaymentOne">
                            <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapsePaymentOne" aria-expanded="true" aria-controls="faqcollapsePaymentOne">
                              What is an auction?
                            </button>
                          </h2>
                          <div id="faqcollapsePaymentOne" className="accordion-collapse collapse show" aria-labelledby="faqheadingPaymentOne" data-bs-parent="#accordionPayment">
                            <div className="accordion-body">
                              An auction is a public sale where goods or services are sold to the highest bidder. Bidders compete to offer the highest price, and the item is awarded to the bidder with the highest bid when the auction ends.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingPaymentTwo">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapsePaymentTwo" aria-expanded="false" aria-controls="faqcollapsePaymentTwo">
                              How do auctions work?
                            </button>
                          </h2>
                          <div id="faqcollapsePaymentTwo" className="accordion-collapse collapse" aria-labelledby="faqheadingPaymentTwo" data-bs-parent="#accordionPayment">
                            <div className="accordion-body">
                              Auctions allow items to be sold to the highest bidder. Participants bid on the item until the highest bid is reached within a set timeframe. The highest bidder wins and pays the bid amount.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingPaymentThree">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapsePaymentThree" aria-expanded="false" aria-controls="faqcollapsePaymentThree">
                              What types of auctions are there?
                            </button>
                          </h2>
                          <div id="faqcollapsePaymentThree" className="accordion-collapse collapse" aria-labelledby="faqheadingPaymentThree" data-bs-parent="#accordionPayment">
                            <div className="accordion-body">
                              Types of auctions include English (ascending bid), Dutch (descending bid), sealed-bid (highest bid wins), and Vickrey (sealed-bid, second-highest bid wins). Additionally, there are reverse (lowest bid wins) and silent (secret bids) auctions, catering to various selling dynamics and bidder preferences.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingPaymentFour">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapsePaymentFour" aria-expanded="false" aria-controls="faqcollapsePaymentFour">
                              Who can participate in auctions?
                            </button>
                          </h2>
                          <div id="faqcollapsePaymentFour" className="accordion-collapse collapse" aria-labelledby="faqheadingPaymentFour" data-bs-parent="#accordionPayment">
                            <div className="accordion-body">
                              Anyone meeting auction requirements, typically 18 years or older, can participate. Registration may be necessary, depending on the auction platform. Ensure compliance with specific auction rules and regulations.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingPaymentFive">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapsePaymentFive" aria-expanded="false" aria-controls="faqcollapsePaymentFive">
                              What happens if I win an auction?
                            </button>
                          </h2>
                          <div id="faqcollapsePaymentFive" className="accordion-collapse collapse" aria-labelledby="faqheadingPaymentFive" data-bs-parent="#accordionPayment">
                            <div className="accordion-body">
                              If you win an auction, you're obligated to purchase the item at the winning bid price. Follow payment instructions provided by the auction platform. Non-compliance may lead to penalties or account suspension.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingPaymentSix">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapsePaymentSix" aria-expanded="false" aria-controls="faqcollapsePaymentSix">
                              Can I sell items at auctions?
                            </button>
                          </h2>
                          <div id="faqcollapsePaymentSix" className="accordion-collapse collapse" aria-labelledby="faqheadingPaymentSix" data-bs-parent="#accordionPayment">
                            <div className="accordion-body">
                              Yes, you can sell items at auctions. Register with the auction house or platform, provide item details, and agree to the terms, including fees and commissions. This process can help you reach a wide audience and achieve competitive prices.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingPaymentSeven">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapsePaymentSeven" aria-expanded="false" aria-controls="faqcollapsePaymentSeven">
                              Are there risks associate with buying at auctions?
                            </button>
                          </h2>
                          <div id="faqcollapsePaymentSeven" className="accordion-collapse collapse" aria-labelledby="faqheadingPaymentSeven" data-bs-parent="#accordionPayment">
                            <div className="accordion-body">
                              No, buying at auctions can be advantageous. You can find unique items, often at lower prices than retail. Auctions also offer a transparent buying process and the excitement of competitive bidding.
                            </div>
                          </div>
                        </div>
                      </div>
                ...
                <div className="tab-pane fade" id="bidding" role="tabpanel" aria-labelledby="bidding-tab" tabIndex={0}>
                  <div className="faq-wrappper">
                    <div className="faq-content">
                      <div className="accordion" id="accordionBidding">
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingBiddingOne">
                            <button className="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseBiddingOne" aria-expanded="true" aria-controls="faqcollapseBiddingOne">
                              What is an auction?
                            </button>
                          </h2>
                          <div id="faqcollapseBiddingOne" className="accordion-collapse collapse show" aria-labelledby="faqheadingBiddingOne" data-bs-parent="#accordionBidding">
                            <div className="accordion-body">
                              An auction is a public sale where goods or services are sold to the highest bidder. Bidders compete to offer the highest price, and the item is awarded to the bidder with the highest bid when the auction ends.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingBiddingTwo">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseBiddingTwo" aria-expanded="false" aria-controls="faqcollapseBiddingTwo">
                              How do auctions work?
                            </button>
                          </h2>
                          <div id="faqcollapseBiddingTwo" className="accordion-collapse collapse" aria-labelledby="faqheadingBiddingTwo" data-bs-parent="#accordionBidding">
                            <div className="accordion-body">
                              Auctions allow items to be sold to the highest bidder. Participants bid on the item until the highest bid is reached within a set timeframe. The highest bidder wins and pays the bid amount.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingBiddingThree">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseBiddingThree" aria-expanded="false" aria-controls="faqcollapseBiddingThree">
                              What types of auctions are there?
                            </button>
                          </h2>
                          <div id="faqcollapseBiddingThree" className="accordion-collapse collapse" aria-labelledby="faqheadingBiddingThree" data-bs-parent="#accordionBidding">
                            <div className="accordion-body">
                              Types of auctions include English (ascending bid), Dutch (descending bid), sealed-bid (highest bid wins), and Vickrey (sealed-bid, second-highest bid wins). Additionally, there are reverse (lowest bid wins) and silent (secret bids) auctions, catering to various selling dynamics and bidder preferences.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingBiddingFour">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseBiddingFour" aria-expanded="false" aria-controls="faqcollapseBiddingFour">
                              Who can participate in auctions?
                            </button>
                          </h2>
                          <div id="faqcollapseBiddingFour" className="accordion-collapse collapse" aria-labelledby="faqheadingBiddingFour" data-bs-parent="#accordionBidding">
                            <div className="accordion-body">
                              Anyone meeting auction requirements, typically 18 years or older, can participate. Registration may be necessary, depending on the auction platform. Ensure compliance with specific auction rules and regulations.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingBiddingFive">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseBiddingFive" aria-expanded="false" aria-controls="faqcollapseBiddingFive">
                              What happens if I win an auction?
                            </button>
                          </h2>
                          <div id="faqcollapseBiddingFive" className="accordion-collapse collapse" aria-labelledby="faqheadingBiddingFive" data-bs-parent="#accordionBidding">
                            <div className="accordion-body">
                              If you win an auction, you're obligated to purchase the item at the winning bid price. Follow payment instructions provided by the auction platform. Non-compliance may lead to penalties or account suspension.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingBiddingSix">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseBiddingSix" aria-expanded="false" aria-controls="faqcollapseBiddingSix">
                              Can I sell items at auctions?
                            </button>
                          </h2>
                          <div id="faqcollapseBiddingSix" className="accordion-collapse collapse" aria-labelledby="faqheadingBiddingSix" data-bs-parent="#accordionBidding">
                            <div className="accordion-body">
                              Yes, you can sell items at auctions. Register with the auction house or platform, provide item details, and agree to the terms, including fees and commissions. This process can help you reach a wide audience and achieve competitive prices.
                            </div>
                          </div>
                        ...
                        <div className="accordion-item">
                          <h2 className="accordion-header" id="faqheadingBiddingSeven">
                            <button className="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#faqcollapseBiddingSeven" aria-expanded="false" aria-controls="faqcollapseBiddingSeven">
                              Are there risks associate with buying at auctions?
                            </button>
                          </h2>
                          <div id="faqcollapseBiddingSeven" className="accordion-collapse collapse" aria-labelledby="faqheadingBiddingSeven" data-bs-parent="#accordionBidding">
                            <div className="accordion-body">
                              No, buying at auctions can be advantageous. You can find unique items, often at lower prices than retail. Auctions also offer a transparent buying process and the excitement of competitive bidding.
                            </div>
                          </div>
