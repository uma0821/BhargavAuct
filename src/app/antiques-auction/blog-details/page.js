...
const CarAuctionBlogDetails = () => {
  return (
    <>
      <Header3 />
      <Breadcrumb3 pagetitle="Blog Details" currentPage="Blog Details" />
      <div className="blog-details-page pt-110 mb-110">
        <div className="container">
              ...
              <div className="sidebar-area">
                ...
                <div className="single-widget mb-30">
                  ...
                  <ul className="category-list">
                    ...
                    <li>
                      <Link href="/antiques-auction/blog-sidebar">
                        Books &amp; Comic
                        <span>(40)</span>
                      </Link>
                    </li>
                ...
                <div className="single-widget mb-30">
                  ...
                  <ul className="tag-list">
                    <li>
                      <Link href="/antiques-auction/blog-grid">Porcelain</Link>
                    </li>
                    <li>
                      <Link href="/antiques-auction/blog-grid">
                        Manuscripts
                    ...
                    <li>
                      <Link href="/antiques-auction/blog-grid">Ceramics</Link>
                    </li>
                    <li>
                      <Link href="/antiques-auction/blog-grid">
                        Renaissance
                    ...
                    <li>
                      <Link href="/antiques-auction/blog-grid">Rococo Art</Link>
                    </li>
                    <li>
                      <Link href="/antiques-auction/blog-grid">
                        Romanticism
          ...
          <div className="blog-tag">
            ...
            <ul>
              <li>
                <Link href="/antiques-auction/blog-grid">Industry,</Link>
              </li>
              <li>
                <Link href="/antiques-auction/blog-grid">Marketing,</Link>
              </li>
              <li>
                <Link href="/antiques-auction/blog-grid">Technology,</Link>
              </li>
              <li>
                <Link href="/antiques-auction/blog-grid">Health Care</Link>
              </li>
            </ul>
          </div>
