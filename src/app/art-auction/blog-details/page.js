...
const CarAuctionBlogDetails = () => {
  return (
    <>
      <Header4 />
      <Breadcrumb4 pagetitle="Blog Details" currentPage="Blog Details" />
      <div className="blog-details-page pt-110 mb-110">
        <div className="container">
              ...
              <div className="blog-details-author-meta">
                <div className="author-area">
                  ...
                  <div className="author-content">
                    <h6>
                      By, <Link href="/art-auction/blog-grid">Cooper Jogan</Link>
                    </h6>
                  </div>
                </div>
                <ul>
              ...
              <div className="sidebar-area">
                ...
                <div className="single-widget mb-30">
                  ...
                  <ul className="category-list">
                    <li>
                      <Link href="/art-auction/blog-grid">
                        Digital Art
                        <span>(20)</span>
                      </Link>
                    </li>
                    ...
                    <li>
                      <Link href="/art-auction/blog-sidebar">
                        Books &amp; Comic
                        <span>(40)</span>
                      </Link>
                    </li>
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/art-auction/blog-grid">20 February, 2024</Link>
                      <h6>
                        <Link href="/art-auction/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/art-auction/blog-grid">12 January, 2024</Link>
                      <h6>
                        <Link href="/art-auction/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/art-auction/blog-grid">04 January, 2024</Link>
                      <h6>
                        <Link href="/art-auction/blog-details">
                ...
                <div className="single-widget mb-30">
                  ...
                  <ul className="tag-list">
                    <li>
                      <Link href="/art-auction/blog-grid">Porcelain</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Manuscripts</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Ceramics</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Renaissance</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Baroque Art</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Rococo Art</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Romanticism</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Photography</Link>
                    </li>
                    <li>
                      <Link href="/art-auction/blog-grid">Smartwatches</Link>
                    </li>
                  </ul>
                </div>
          ...
          <div className="blog-tag">
            ...
            <ul>
              <li>
                <Link href="/art-auction/blog-grid">Industry,</Link>
              </li>
              <li>
                <Link href="/art-auction/blog-grid">Marketing,</Link>
              </li>
              <li>
                <Link href="/art-auction/blog-grid">Technology,</Link>
              </li>
              <li>
                <Link href="/art-auction/blog-grid">Health Care</Link>
              </li>
            </ul>
          </div>
            ...
            <div className="col-lg-12">
              <div className="details-navigation">
                <div className="single-navigation">
                  <Link href="/art-auction/blog-details" className="nav-btn">
                    <div className="arrow">
                      <svg
                        width={16}
                        height={13}
