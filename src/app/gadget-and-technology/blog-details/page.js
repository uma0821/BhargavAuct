...
const CarAuctionBlogDetails = () => {
  return (
    <>
      <InnerPageHeader5 />
      <Breadcrumb5 pagetitle="Blog Details" currentPage="Blog Details" />
      <div className="blog-details-page pt-110 mb-110">
        <div className="container">
          ...
          <div className="blog-tag">
            ...
            <ul>
              <li>
                <Link href="/gadget-and-technology/blog-grid">Industry,</Link>
              </li>
              <li>
                <Link href="/gadget-and-technology/blog-grid">Marketing,</Link>
              </li>
              <li>
                <Link href="/gadget-and-technology/blog-grid">Technology,</Link>
              </li>
              <li>
                <Link href="/gadget-and-technology/blog-grid">Health Care</Link>
              </li>
            </ul>
          </div>
            ...
            <div className="col-lg-12">
              <div className="details-navigation">
                <div className="single-navigation">
                  <Link
                    href="/gadget-and-technology/blog-details"
                    className="nav-btn"
                  >
                    <div className="arrow">
                      <svg
