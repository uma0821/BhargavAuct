...
const AuctionGridPage = () => {
  ...
  return (
    <>
      <InnerPageHeader5 />
      <Breadcrumb5 currentPage={"Auction Grid"} pagetitle={"Auction Grid"} />
                ...
                <div className="auction-card style-5">
                  <div className="auction-card-img-wrap">
                    <Link
                      ...
                      className="card-img"
                    >
                      <img src="../assets/img/home5/auction-img11.jpg" alt="" />
                    </Link>
                    <div className="batch">
                      <span className="upcoming">
                        <svg
                ...
                <div className="auction-card style-5">
                  <div className="auction-card-img-wrap">
                    <Link
                      ...
                      className="card-img"
                    >
                      <img src="../assets/img/home5/auction-img12.jpg" alt="" />
                    </Link>
                    <div className="batch">
                      <span className="live">
                        <svg
