...
const CarAuctionBlogDetails = () => {
  return (
    <>
      <Header2 />
      <Breadcrumb2 pagetitle="Blog Details" currentPage="Blog Details" />
      <div className="blog-details-page pt-110 mb-110">
        <div className="container">
              ...
              <div className="blog-details-author-meta">
                <div className="author-area">
                  ...
                  <div className="author-content">
                    <h6>
                      By,{" "}
                      <Link href="/car-auction/blog-grid">Cooper Jogan</Link>
                    </h6>
                  </div>
                </div>
                <ul>
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    <div className="recent-post-img">
                      <Link href="/car-auciton/blog-details">
                        <img
          ...
          <div className="blog-tag">
            ...
            <ul>
              <li>
                <Link href="/car-auction/blog-grid">Industry,</Link>
              </li>
              <li>
                <Link href="/car-auction/blog-grid">Marketing,</Link>
              </li>
              <li>
                <Link href="/car-auction/blog-grid">Technology,</Link>
              </li>
              <li>
                <Link href="/car-auction/blog-grid">Health Care</Link>
              </li>
            </ul>
          </div>
            ...
            <div className="col-lg-12">
              <div className="details-navigation">
                <div className="single-navigation">
                  <Link href="/car-auciton/blog-details" className="nav-btn">
                    <div className="arrow">
                      <svg
                        width={16}
                        height={13}
