...
const BlogDetailsPage = () => {
  return (
    <>
      <InnerPageHeader1 />
      <Breadcrumb1 currentPage="Blog Details" pagetitle="Blog Details" />
      <div className="blog-details-page pt-110 mb-110">
        <div className="container">
              ...
              <div className="blog-details-author-meta">
                <div className="author-area">
                  ...
                  <div className="author-content">
                    <h6>
                      By, <Link href="/blog-grid">Cooper Jogan</Link>
                    </h6>
                  </div>
                </div>
                <ul>
              ...
              <div className="sidebar-area">
                ...
                <div className="single-widget mb-30">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/blog-grid">20 February, 2024</Link>
                      <h6>
                        <Link href="/blog-details">
                  ...
                  <div className="recent-post-widget mb-20">
                    ...
                    <div className="recent-post-content">
                      <Link href="/blog-grid">04 January, 2024</Link>
                      <h6>
                        <Link href="/blog-details">
                ...
                <div className="single-widget mb-30">
                  ...
                  <ul className="tag-list">
                    <li>
                      <Link href="blog-grid">Porcelain</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Manuscripts</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Ceramics</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Renaissance</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Baroque Art</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Rococo Art</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Romanticism</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Photography</Link>
                    </li>
                    <li>
                      <Link href="blog-grid">Smartwatches</Link>
                    </li>
                  </ul>
                </div>
          ...
          <div className="blog-tag">
            ...
            <ul>
              <li>
                <Link href="/blog-grid">Industry,</Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/blog-grid">Health Care</Link>
              </li>
            </ul>
          </div>
            ...
            <div className="col-lg-12">
              <div className="details-navigation">
                <div className="single-navigation">
                  <Link href="/blog-details" className="nav-btn">
                    <div className="arrow">
                      <svg
                        width={16}
                        height={13}
