...
export async function POST(req) {
  ...
  try {
    ...
    // Insert query
    const insertQuery = `INSERT INTO lot_detail(lot_code,lot_name, lot_auct_id, lot_type, lot_est_min_bid, lot_est_max_bid, lot_min_incr, lot_open_bid, lot_cat_id, lot_mat_id, lot_front_img, lot_thumb_img, lot_large_img, lot_status, lot_description, lot_img_1, lot_img_2, lot_img_3)
    VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?);`;
    ...
    return NextResponse.json({ message: "Lot added Successfully" }, { status: 200, headers: {
      ...corsHeaders,
