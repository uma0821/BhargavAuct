...
const Home6HighlightAuction = () => {
  ...
  return (
    <>
      <div className="home6-highlight-auction-section mb-110">
          ...
          >
            <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
              <div className="section-title4 two">
                ...
                <h2>
                  Highlight <span>Auction</span>
                </h2>
              </div>
              <div className="selector">
                <SelectComponent
                  placeholder={"All Auction"}
                  options={["Comics", "Biography", "Philosophy", "All Auction"]}
                />
              </div>
            </div>
          </div>
          <div className="row g-4 mb-60">
            ...
            >
              <div className="auction-banner-card">
                <img
                  src="../assets/img/home6/auction-banner-card-img1.jpg"
                  alt=""
                />
                <div className="banner-content-wrap">
                  ...
                  <div className="banner-content-bottom">
                    <div className="countdown-timer">
                      <ul data-countdown="2024-09-24 12:00:00">
                        <li data-days={0}>
                          {days}
                          <span>Days</span>
                          <span>Days</span>
              ...
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link
                    ...
                    className="card-img"
                  >
                    <img src="../assets/img/home6/auction-img13.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg
              ...
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link
                    ...
                    className="card-img"
                  >
                    <img src="../assets/img/home6/auction-img14.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg
              ...
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link
                    ...
                    className="card-img"
                  >
                    <img src="../assets/img/home6/auction-img15.jpg" alt="" />
                  </Link>
                  <div className="batch">
                ...
                <div className="auction-card-content">
                  ...
                  <div className="price-and-code-area">
                    ...
                    <Link
                      href="/bookand-comic/auction-details2"
                      className="bid-btn"
                    >
                      Notify Me
                    </Link>
              ...
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link
                    ...
                    className="card-img"
                  >
                    <img src="../assets/img/home6/auction-img16.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg
              ...
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link
                    ...
                    className="card-img"
                  >
                    <img src="../assets/img/home6/auction-img17.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="upcoming">
                      <svg
                  ...
                  <div className="countdown-timer">
                    <ul data-countdown="2024-10-29 12:00:00">
                      <li className="times" data-days={0}>
                        {days}
                        <span>Days</span>
                      </li>
              ...
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link
                    ...
                    className="card-img"
                  >
                    <img src="../assets/img/home6/auction-img18.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg
            ...
            >
              <div className="auction-banner-card">
                <img
                  src="../assets/img/home6/auction-banner-card-img2.jpg"
                  alt=""
                />
                <div className="banner-content-wrap">
                  <div className="banner-content-top">
          ...
          >
            <div className="col-lg-12 d-flex justify-content-center">
              <Link
                ...
                href="/bookand-comic/auction-grid"
              >
                View All Auction
                <div className="arrow">
                  <svg
...
export default Home6HighlightAuction;
