...
const Home5AuctionCard = () => {
  const { days, hours, minutes, seconds } = useCountdownTimer(
    "2024-10-23 12:00:00"
  );
  return (
    <>
      <div className="home5-auction-card-tab-section mb-110">
        <div className="container">
          ...
          >
            <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
              <div className="section-title4">
                ...
                <h2>
                  Find Your <span>Favorites</span>
                </h2>
              </div>
              <Link
                className="view-button2 two"
          ...
          <div
            className="auction-nav wow animate fadeInUp"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
            <nav>
              <div className="nav nav-tabs" id="nav-tab" role="tablist">
                ...
                <button
                  ...
                  id="smart-phone-tab"
                  data-bs-toggle="tab"
                  data-bs-target="#smart-phone"
                  type="button"
                  role="tab"
                  aria-controls="smart-phone"
                  aria-selected="false"
                >
                  Smart Phone
                </button>
          ...
          <div
            className="auction-tab-area wow animate fadeInUp"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
            <div className="tab-content" id="nav-tabContent">
              ...
              >
                <div className="row g-4 justify-content-center">
                  <div className="col-xl-3 col-md-6 order-xl-1 order-1">
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5">
                          <div className="auction-card-img-wrap">
                            ...
                            >
                              <img
                                src="../assets/img/home5/auction-img5.jpg"
                                alt=""
                              />
                            </Link>
                            <div className="batch">
                  ...
                  <div className="col-xl-6 col-lg-8 order-xl-2 order-3">
                    <div className="row g-4">
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            <Link
                              href="/gadget-and-technology/auction-details"
                              className="card-img"
                            >
                              <img
                                src="../assets/img/home5/auction-img7.jpg"
                                alt=""
                              />
                            </Link>
                            <div className="batch">
                          ...
                          <div className="auction-card-content">
                            <h6>
                              <Link href="/gadget-and-technology/auction-details">
                                Solar Sync Apple Iphone 15 Pro max.
                              </Link>
                            </h6>
                            <div className="price-and-code-area">
                              <div className="price">
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            ...
                            >
                              <img
                                src="../assets/img/home5/auction-img8.jpg"
                                alt=""
                              />
                            </Link>
                            <div className="batch">
                            ...
                            <div className="countdown-timer">
                              <ul data-countdown="2024-10-25 12:00:00">
                                <li className="times" data-days={0}>
                                  {days}
                                  <span>Days</span>
                                </li>
                          ...
                          <div className="auction-card-content">
                            <h6>
                              <Link href="/gadget-and-technology/auction-details">
                                Quantum Quick-Computer Cooling fan.
                              </Link>
                            </h6>
                            <div className="price-and-code-area">
                              <div className="price">
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            ...
                            >
                              <img
                                src="../assets/img/home5/auction-img9.jpg"
                                alt=""
                              />
                            </Link>
                            <div className="batch">
                          ...
                          <div className="auction-card-content">
                            <h6>
                              <Link href="/gadget-and-technology/auction-details">
                                Nebula Noise-Canceling New Headphones.
                              </Link>
                            </h6>
                            <div className="price-and-code-area">
                              <div className="price">
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5 horizontal-d">
                          <div className="auction-card-img-wrap">
                            ...
                            >
                              <img
                                src="../assets/img/home5/auction-img10.jpg"
                                alt=""
                              />
                            </Link>
                            <div className="batch">
                            ...
                            <div className="countdown-timer">
                              <ul data-countdown="2024-11-18 12:00:00">
                                <li className="times" data-days={0}>
                                  {days}
                                  <span>Days</span>
                                </li>
                          ...
                          <div className="auction-card-content">
                            <h6>
                              <Link href="/gadget-and-technology/auction-details">
                                Marketplace Art Auction Extra Masterpiece.
                              </Link>
                            </h6>
                            <div className="price-and-code-area">
                              <div className="price">
                  ...
                  <div className="col-xl-3 col-md-6 order-xl-3 order-2">
                    <div className="row g-4">
                      <div className="col-lg-12">
                        <div className="auction-card style-5">
                          <div className="auction-card-img-wrap">
                          ...
                          <div className="auction-card-content">
                            <h6>
                              <Link href="/gadget-and-technology/auction-details">
                                Stream Tech Digital Camera Stick Free.
                              </Link>
                            </h6>
                            <div className="price-and-code-area">
                              <div className="price">
                      ...
                      <div className="col-lg-12">
                        <div className="auction-card style-5">
                          <div className="auction-card-img-wrap">
                            ...
                            >
                              <img
                                src="../assets/img/home5/auction-img6.jpg"
                                alt=""
                              />
                            </Link>
                            <div className="batch">
                            ...
                            <div className="countdown-timer">
                              <ul data-countdown="2024-10-03 12:00:00">
                                <li className="times" data-days={0}>
                                  {days}
                                  <span>Days</span>
                                </li>
                          ...
                          <div className="auction-card-content">
                            <h6>
                              <Link href="/gadget-and-technology/auction-details">
                                Turbo Drive USB Flash Drive with webcam.
                              </Link>
                            </h6>
                            <div className="price-and-code-area">
                              <div className="price">
              ...
              <div
                ...
                id="smart-phone"
                role="tabpanel"
                aria-labelledby="smart-phone-tab"
                tabIndex={0}
              >
                <div className="row g-4 justify-content-center">
                  <div className="col-xl-3 col-md-6 order-xl-1 order-1">
...
export default Home5AuctionCard;
