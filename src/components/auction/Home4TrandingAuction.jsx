...
const Home4TrandingAuction = () => {
  ...
  return (
    <>
      <div className="home4-trending-auction-section mb-120">
        <div className="container">
          ...
          <div className="row mb-50">
            <div className="col-lg-12">
              <Swiper {...setttings} className="swiper auction-slider">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        ...
                        >
                          <img
                            src="../assets/img/home4/auction-img9.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="auction-card-content">
                        <h6>
                          <Link href="/art-auction/auction-details">
                            Canvas Conclavi Elite Auction Art Experience.
                          </Link>
                        </h6>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        ...
                        >
                          <img
                            src="../assets/img/home4/auction-img10.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="auction-card-content">
                        <h6>
                          <Link href="/art-auction/auction-details">
                            Masterworks Auctions Where Art Finds a Home.
                          </Link>
                        </h6>
                        <div className="price-and-code-area">
                          <div className="price">
                          ...
                          <Link
                            href="/art-auction/auction-details2"
                            className="bid-btn"
                          >
                            Notify Me
                          </Link>
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        ...
                        >
                          <img
                            src="../assets/img/home4/auction-img11.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="auction-card-content">
                        <h6>
                          <Link href="/art-auction/auction-details">
                            Brushed Brilliance Modernity Art Auction.
                          </Link>
                        </h6>
                        <div className="price-and-code-area">
                          <div className="price">
                  ...
                  <SwiperSlide className="swiper-slide">
                    <div className="auction-card style-4">
                      <div className="auction-card-img-wrap">
                        ...
                        >
                          <img
                            src="../assets/img/home4/auction-img12.jpg"
                            alt=""
                          />
                        </Link>
                        <div className="batch">
                      ...
                      <div className="auction-card-content">
                        <h6>
                          <Link href="/art-auction/auction-details">
                            Auction House of Art Premier Auction Event.
                          </Link>
                        </h6>
                        <div className="price-and-code-area">
                          <div className="price">
...
export default Home4TrandingAuction;
