...
const Home6PopularAuction = () => {
  ...
  return (
    <>
      <div className="home6-popular-auction-section mb-110">
        <div className="container">
          ...
          <div
            className="auction-slider-area mb-50 wow animate fadeInUp"
            data-wow-delay="200ms"
            data-wow-duration="1500ms"
          >
            <div className="row">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-6">
                        ...
                        <div className="auction-card-content">
                          <h6>
                            <Link href="/book-and-comic/auction-details">
                              Unique Discover Rare Edition of criminal
                              Successor.
                            </Link>
                          </h6>
                          <div className="price-and-code-area">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-6">
                        ...
                        <div className="auction-card-content">
                          <h6>
                            <Link href="/book-and-comic/auction-details">
                              Modern Rariti First Printing of Alex rider by
                              Munby.
                            </Link>
                          </h6>
                          <div className="price-and-code-area">
...
export default Home6PopularAuction;
