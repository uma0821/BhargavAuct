        ...
        <div className="container">
          ...
          >
            <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
              <div className="section-title2">
                ...
                <h2>
                  Highest Bidding <span>Auction</span>
                </h2>
              </div>
              <ul className="nav nav-pills" id="pills-tab" role="tablist">
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    id="porcelain-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#porcelain"
                    type="button"
                    role="tab"
                    aria-controls="porcelain"
                    aria-selected="true"
                  >
                    Porcelain
                  </button>
                ...
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    id="manuscripts-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#manuscripts"
                    type="button"
                    role="tab"
                    aria-controls="manuscripts"
                    aria-selected="false"
                  >
                    Manuscripts
                  </button>
                ...
                <li className="nav-item" role="presentation">
                  <button
                    ...
                    id="ceramics-tab"
                    data-bs-toggle="pill"
                    data-bs-target="#ceramics"
                    type="button"
                    role="tab"
                    aria-controls="ceramics"
                    aria-selected="false"
                  >
                    Ceramics
                  </button>
          ...
          <div className="tab-content" id="pills-tabContent">
                ...
                >
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      ...
                      >
                        <img
                          src="../assets/img/home3/auction-img4.jpg"
                          alt=""
                        />
                      </Link>
                      <div className="batch">
                    ...
                    <div className="auction-card-content">
                      <h6>
                        <Link href="/antiques-auction/auction-details">
                          Art decorat bronze sculpture antique pot.{" "}
                        </Link>
                      </h6>
                      <div className="price-and-code-area">
                        <div className="price">
                        ...
                        <Link
                          href="/antiques-auction/auction-details2"
                          className="bid-btn"
                        >
                          Notify Me
                        </Link>
                ...
                >
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      ...
                      >
                        <img
                          src="../assets/img/home3/auction-img5.jpg"
                          alt=""
                        />
                      </Link>
                      <div className="batch">
                    ...
                    <div className="auction-card-content">
                      <h6>
                        <Link href="/antiques-auction/auction-details">
                          18th century chines antique porcelain vase.
                        </Link>
                      </h6>
                      <div className="price-and-code-area">
                        <div className="price">
                ...
                >
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      ...
                      >
                        <img
                          src="../assets/img/home3/auction-img6.jpg"
                          alt=""
                        />
                      </Link>
                      <div className="batch">
                ...
                >
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      ...
                      >
                        <img
                          src="../assets/img/home3/auction-img7.jpg"
                          alt=""
                        />
                      </Link>
                      <div className="batch">
                    ...
                    <div className="auction-card-content">
                      <h6>
                        <Link href="/antiques-auction/auction-details">
                          Colonial revival dining chairs with old book.
                        </Link>
                      </h6>
                      <div className="price-and-code-area">
                        <div className="price">
                ...
                >
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      ...
                      >
                        <img
                          src="../assets/img/home3/auction-img8.jpg"
                          alt=""
                        />
                      </Link>
                      <div className="batch">
                    ...
                    <div className="auction-card-content">
                      <h6>
                        <Link href="/antiques-auction/auction-details">
                          Regency perioded chandelier jug with pot.
                        </Link>
                      </h6>
                      <div className="price-and-code-area">
                        <div className="price">
                ...
                >
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      ...
                      >
                        <img
                          src="../assets/img/home3/auction-img9.jpg"
                          alt=""
                        />
                      </Link>
                      <div className="batch">
                    ...
                    <div className="auction-card-content">
                      <h6>
                        <Link href="/antiques-auction/auction-details">
                          Edwardian diamond brooch old song cover.
                        </Link>
                      </h6>
                      <div className="price-and-code-area">
                        <div className="price">
                ...
                >
                  <div className="auction-card style-3">
                    <div className="auction-card-img-wrap">
                      ...
                      >
                        <img
                          src="../assets/img/home3/auction-img10.jpg"
                          alt=""
                        />
                      </Link>
                      <div className="batch">
                    ...
                    <div className="auction-card-content">
                      <h6>
                        <Link href="/antiques-auction/auction-details">
                          Arts and crafts pottery vase wall big clock.
                        </Link>
                      </h6>
                      <div className="price-and-code-area">
                        <div className="price">
            ...
            <div
              ...
              id="manuscripts"
              role="tabpanel"
              aria-labelledby="manuscripts-tab"
              tabIndex={0}
            >
              <div className="row g-4 mb-50">
                <div className="col-xl-3 col-lg-4 col-md-6">
...
export default Home3HighestBidding;
