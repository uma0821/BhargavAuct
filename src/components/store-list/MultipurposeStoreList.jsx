                  ...
                  <div className="store-card-content">
                    <div className="profile-area">
                      ...
                      <div className="profile-content">
                        <h5><Link href="/store-details">{name}</Link></h5>
                    ...
                    <Link className="primary-btn btn-hover" href="/store-details">
                      View Store
...
export default MultipurposeStoreList
