// src/components/current-auction
...
const CurrentAuction = () => {
  ...
  const { auction: liveAuctions,loading, error } = useSelector((state) => state.auction);
  const lotData = [];
            ...
            {liveAuctions ? (
              <>
                <div className="row g-4 mb-60">
                  { liveAuctions.length > 0 ? liveAuctions
                      .map((auct) => {
                        return (
                          <div
