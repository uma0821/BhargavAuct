      ...
      <div className="container">
        <div className="row mb-60">
          <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
            ...
            <Link className="view-button wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms" href="/auction-grid">
              View All Auction
        ...
        <div className="row g-4">
          <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/auction-details">Vintage valor embracing then elegance of eras past.</Link>
                </h6>
                ...
                <div className="author-and-btn-area">
                  <Link href="/store-details" className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img5.png" alt="" />
                    </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/auction-details">Canvas &amp; culture brush withn elegance auction.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$9,458</strong>
                ...
                <div className="author-and-btn-area">
                  <Link href="/store-details" className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img6.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>John Hudson</h6>
                    </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/auction-details">Nostalgian hookup memories reside in every piece.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  <Link href="/store-details" className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img7.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>Leo Jackson</h6>
                    </div>
            ...
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                ...
                <div className="author-and-btn-area">
                  <Link href="/store-details" className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img8.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>Samuel Ethan</h6>
                    </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/auction-details">Electro edge redefining times possibilities gadget.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  <Link href="/store-details" className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img9.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>Owen Asher</h6>
                    </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/auction-details">Coin crest cresting the peak of numismatic.</Link></h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                    <strong>$5,578</strong>
                ...
                <div className="author-and-btn-area">
                  <div className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img10.png" alt="" />
                    </div>
                    <div className="author-content">
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/auction-details">Pixela prodigy inspiring pixels time creators one.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  <Link href="/store-details" className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img11.png" alt="" />
                    </div>
                    <div className="author-content">
                      <h6>Daniel Jack</h6>
                    </div>
          ...
          <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="auction-card">
              ...
              <div className="auction-card-content">
                <h6><Link href="/auction-details">Gizmo galaxy your universent of cutting edge tech.</Link>
                </h6>
                <div className="price-and-code-area">
                  <div className="price">
                    <span>Current Bid at:</span>
                ...
                <div className="author-and-btn-area">
                  <Link href="/store-details" className="author-area">
                    <div className="author-img">
                      <img src="assets/img/home1/auction-card-author-img12.png" alt="" />
                    </div>
                    <div className="author-content">
