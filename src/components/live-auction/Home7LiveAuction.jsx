    ...
    <>
      <div className="home7-live-auction-section mb-110">
        <div className="container-one">
          ...
          <div className="auction-slider-area mb-50 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="row">
              <div className="col-lg-12">
                <Swiper {...settings} className="swiper home7-auction-slider">
                  <div className="swiper-wrapper">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-7">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/multipurpose2/auction-details">Antique Charm Elegant Within Statement.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$3,674</strong>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-7">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/multipurpose2/auction-details">Heritage had curating watch time treasures.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$8,974</strong>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-7">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/multipurpose2/auction-details">Vintage valor embracing then elegance of eras.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$4,648</strong>
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-7">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/multipurpose2/auction-details">Titan motors built to conquer every milen.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$6,367</strong>
                            </div>
                            <Link href="/multipurpose2/auction-details" className="bid-btn">Bid Now</Link>
                          </div>
                        </div>
                      </div>
                    </SwiperSlide>
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-7">
                        ...
                        <div className="auction-card-content">
                          <h6><Link href="/multipurpose2/auction-details">Neo-classical marble busting rustic farmhouse.</Link></h6>
                          <div className="price-and-code-area">
                            <div className="price">
                              <span>Current Bid at:</span>
                              <strong>$5,237</strong>
          ...
          <div className="row wow animate fadeInUp" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-lg-12 d-flex justify-content-center">
              <Link className="primary-btn6 transparent btn-hover" href="/multipurpose2/auction-grid">
                View All Auction
                <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
...
export default Home7LiveAuction
