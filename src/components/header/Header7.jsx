          ...
          <div className="container">
            <div className="topbar-wrap">
              ...
              <div className="topbar-right">
                <ul>
                  <li>
                    <Link href="/multipurpose2/how-to-buy">HOW TO BID</Link>
                  </li>
                  <li>
                    <Link href="/multipurpose2/how-to-sell">SELL YOUR ITEM</Link>
                  </li>
                </ul>
          ...
          <div className="nav-left">
            ...
            <div className={`main-menu ${isMenuOpen ? "show-menu" : ""}`}>
              ...
              <ul className="menu-list">
                ...
                <li
                  className={`menu-item-has-children ${pathName === "/multipurpose2/auction-grid"&& "/multipurpose2/auction-sidebar"&&"/multipurpose2/auction-details"&&"/multipurpose2/auction-details2" ? "active" : ""
                    }`}
                >
                  <Link
                  ...
                  >
                    <li className={pathName==="/multipurpose2/auction-grid"?"active":""}>
                      <Link href="/multipurpose2/auction-grid">
                        Auctions Grid
                      </Link>
                    </li>
                    <li className={pathName==="/multipurpose2/auction-sidebar"?"active":""}>
                      <Link href="/multipurpose2/auction-sidebar">
                        Auctions Sidebar
                      </Link>
                    </li>
                    <li className={pathName==="/multipurpose2/auction-details"?"active":""}>
                      <Link href="/multipurpose2/auction-details">
                        Auctions Details Style 01
                      </Link>
                    </li>
                    <li className={pathName==="/multipurpose2/auction-details2"?"active":""}>
                      <Link href="/multipurpose2/auction-details2">
                        Auctions Details Style 02
                      </Link>
                    </li>
                  </ul>
                </li>
                <li   className={`menu-item-has-children ${pathName === "/multipurpose2/blog-grid"&& "/multipurpose2/blog-standard"&&"/multipurpose2/blog-details"? "active" : ""
                    }`}>
                  <Link href="/multipurpose2/blog-grid" className="drop-down">
                    Blog
                  </Link>
                  <i
                  ...
                  >
                    <li className={pathName==="/multipurpose2/blog-grid"?"active":""}>
                      <Link href="/multipurpose2/blog-grid">Blog Grid</Link>
                    </li>
                    <li className={pathName==="/multipurpose2/blog-standard"?"active":""}>
                      <Link href="/multipurpose2/blog-standard">
                        Blog Standard
                      </Link>
                    </li>
                    <li className={pathName==="/multipurpose2/blog-details"?"active":""}>
                ...
                <li className="menu-item-has-children">
                  ...
                  >
                    <li className={pathName==="/multipurpose2/about"?"active":""}>
                      <Link href="/multipurpose2/about">About</Link>
                    </li>
                    <li className={pathName==="/multipurpose2/category"?"active":""}>
                      <Link href="/multipurpose2/category">Category</Link>
                    </li>
                    <li className={pathName==="/multipurpose2/store-list"?"active":""} >
                      <Link href="/multipurpose2/store-list">Seller</Link>
                      <i
                      ...
                      >
                        <li className={pathName==="/multipurpose2/store-list"?"active":""}>
                          <Link href="/multipurpose2/store-list">
                            Seller List
                          </Link>
                        </li>
                        <li className={pathName==="/multipurpose2/store-details"?"active":""}>
                          <Link href="/multipurpose2/store-details">
                            Seller Details
                          </Link>
                        </li>
                      </ul>
                    </li>
                    <li className={pathName==="/multipurpose2/how-to-sell"?"active":""}>
                      <Link href="/multipurpose2/how-to-sell">How To Sell</Link>
                    </li>
                    <li className={pathName==="/multipurpose2/how-to-buy"?"active":""}>
                      <Link href="/multipurpose2/how-to-buy">How to Bid</Link>
                    </li>
                    <li className={pathName==="/multipurpose2/dashboard"?"active":""}>
                      <Link href="/multipurpose2/dashboard">Dashbaord</Link>
                    </li>
                    <li className={pathName==="/multipurpose2/faq"?"active":""}>
                      <Link href="/multipurpose2/faq">Faqs</Link>
                    </li>
                    <li>
                      <Link href="/multipurpose2/error">Error</Link>
                    </li>
                  </ul>
                </li>
                <li className={pathName==="/multipurpose2/contact"?"active":""}>
                  <Link href="/multipurpose2/contact" className="drop-down">
                    Contact
                  </Link>
                </li>
              </ul>
