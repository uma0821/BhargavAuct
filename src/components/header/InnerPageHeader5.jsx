...
const InnerPageHeader5 = () => {
  ...
  return (
    <>
      <div className="header-topbar-area black-bg">
        <div className="topbar-area style-4">
          <div className="container">
            <div className="topbar-wrap">
              ...
              <div className="topbar-right">
                <ul>
                  <li><Link href="/gadget-and-technology/how-to-buy">HOW TO BID</Link></li>
                  <li><Link href="/gadget-and-technology/how-to-sell">SELL YOUR ITEM</Link></li>
                </ul>
        ...
        <header className="header-area style-4 d-flex flex-nowrap align-items-center justify-content-between">
          <div className="nav-left">
            <div className="company-logo">
              <Link href="/gadget-and-technology"><img alt="image" className="img-fluid" src="/assets/img/logo-white.svg" /></Link>
            </div>
            <div className={`main-menu ${isMenuOpen ? "show-menu" : ""}`}>
              <div className="mobile-logo-area d-lg-none d-flex justify-content-center">
                <div className="mobile-logo-wrap">
                  <Link href="/gadget-and-technology"><img alt="image" src="/assets/img/logo.svg" /></Link>
                </div>
              </div>
              <ul className="menu-list">
                ...
                <li
                  className={`menu-item-has-children ${pathName === "/gadget-and-technology/auction-grid"&& "/gadget-and-technology/auction-sidebar"&&"/gadget-and-technology/auction-details"&&"/gadget-and-technology/auction-details2" ? "active" : ""
                  }`}
                >
                  <Link
                  ...
                  >
                    <li className={pathName==="/gadget-and-technology/auction-grid"?"active":""}>
                      <Link href="/gadget-and-technology/auction-grid">
                        Auctions Grid
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/auction-sidebar"?"active":""}>
                      <Link href="/gadget-and-technology/auction-sidebar">
                        Auctions Sidebar
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/auction-details"?"active":""}>
                      <Link href="/gadget-and-technology/auction-details">
                        Auctions Details Style 01
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/auction-details2"?"active":""}>
                      <Link href="/gadget-and-technology/auction-details2">
                        Auctions Details Style 02
                      </Link>
                    </li>
                  </ul>
                </li>
                <li className={`menu-item-has-children ${pathName === "/gedget-and-tecnology/blog-grid"&& "/gedget-and-tecnology/blog-standard"&&"/gedget-and-tecnology/blog-details"? "active" : ""
                    }`}>
                  <Link
                    href="/gadget-and-technology/blog-grid"
                    className="drop-down"
                  >
                    Blog
                  </Link>
                  ...
                  >
                    <li className={pathName==="/gadget-and-technology/blog-grid"?"active":""}>
                      <Link href="/gadget-and-technology/blog-grid">
                        Blog Grid
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/blog-standardd"?"active":""}>
                      <Link href="/gadget-and-technology/blog-standard">
                        Blog Standard
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/blog-details"?"active":""}>
                      <Link href="/gadget-and-technology/blog-details">
                        Blog Details
                      </Link>
                    </li>
                  </ul>
                ...
                <li className="menu-item-has-children">
                  ...
                  >
                    <li className={pathName==="/gadget-and-technology/about"?"active":""}>
                      <Link href="/gadget-and-technology/about">About</Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/category"?"active":""}>
                      <Link href="/gadget-and-technology/category">
                        Category
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/store-list"?"active":""}>
                      <Link href="/gadget-and-technology/store-list">
                        Seller
                      </Link>
                      <i
                      ...
                      >
                        ...
                        <li className={pathName==="/gadget-and-technology/store-details"?"active":""}>
                          <Link href="/gadget-and-technology/store-details">
                            Seller Details
                          </Link>
                        </li>
                      </ul>
                    </li>
                    <li className={pathName==="/gadget-and-technology/how-to-sell"?"active":""}>
                      <Link href="/gadget-and-technology/how-to-sell">
                        How To Sell
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/how-to-buy"?"active":""}>
                      <Link href="/gadget-and-technology/how-to-buy">
                        How to Bid
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/dashboard"?"active":""}>
                      <Link href="/gadget-and-technology/dashboard">
                        Dashbaord
                      </Link>
                    </li>
                    <li className={pathName==="/gadget-and-technology/faq"?"active":""}>
                      <Link href="/gadget-and-technology/faq">Faqs</Link>
                    </li>
                    <li>
                      <Link href="/gadget-and-technology/error">Error</Link>
                    </li>
                  </ul>
                </li>
                <li className={pathName==="/gadget-and-technology/contact"?"active":""}>
                  <Link
                    href="/gadget-and-technology/contact"
                    className="drop-down"
                  >
                    Contact
                  </Link>
              ...
              <div className="btn-area d-lg-none d-flex">
                <a href="#" className="primary-btn4 black-bg btn-hover">
                  <svg width={19} height={19} viewBox="0 0 19 19" xmlns="http://www.w3.org/2000/svg">
                    <path d="M18.0001 9.49996C18.0001 14.1944 14.1945 18 9.50004 18C4.80552 18 1 14.1944 1 9.49996C1 4.80543 4.80552 0.999913 9.50004 0.999913C14.1945 0.999913 18.0001 4.80543 18.0001 9.49996Z" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M12.9007 8.36671C12.9007 10.2445 11.3785 11.7667 9.50064 11.7667C7.62273 11.7667 6.10059 10.2445 6.10059 8.36671C6.10059 6.48897 7.62273 4.96672 9.50064 4.96672C11.3785 4.96672 12.9007 6.48897 12.9007 8.36671Z" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                    <path d="M4.42676 16.3221C4.69869 13.7615 6.86539 11.7667 9.49811 11.7667C12.1309 11.7667 14.2976 13.7616 14.5694 16.3222" strokeMiterlimit={10} strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                  My Account
...
export default InnerPageHeader5
