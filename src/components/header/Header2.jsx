          ...
          <div className="nav-right">
            <div className={`main-menu ${isMenuOpen ? "show-menu" : ""}`}>
              ...
              <ul className="menu-list">
                ...
                <li
                 className={`menu-item-has-children ${pathName === "/car-auction/auction-grid"&&"/car-auction/auction-sidebar"&& "/car-auction/auction-details"&&"/car-auction/auction-details2"? "active" : ""
                 }`}
                >
                  ...
                  >
                    <li  className={pathName==="/car-auction/auction-grid"?"active":""}>
                      <Link href="/car-auction/auction-grid">Auctions Grid</Link>
                    </li>
                    <li className={pathName==="/car-auction/auction-sidebar"?"active":""}>
                      <Link href="/car-auction/auction-sidebar">Auctions Sidebar</Link>
                    </li>
                    <li className={pathName==="/car-auction/auction-details"?"active":""}>
                      <Link href="/car-auction/auction-details">
                        Auctions Details Style 01
                      </Link>
                    </li>
                    <li className={pathName==="/car-auction/auction-details2"?"active":""}>
                ...
                <li className={`menu-item-has-children ${pathName === "/car-auction/blog-grid"&& "/car-auction/blog-standard"&&"/car-auction/blog-details"? "active" : ""
                    }`}>
                  <Link href="/car-auction/blog-grid" className="drop-down">
                    Blog
                  </Link>
                  <i
                    className={`dropdown-icon ${
                  ...
                  >
                    <li className={pathName==="/car-auction/blog-grid"?"active":""}>
                      <Link href="/car-auction/blog-grid">Blog Grid</Link>
                    </li>
                    <li className={pathName==="/car-auction/blog-standard"?"active":""}>
                      <Link href="/car-auction/blog-standard">Blog Standard</Link>
                    </li>
                    <li className={pathName==="/car-auction/blog-details"?"active":""}>
                ...
                <li className="menu-item-has-children">
                  ...
                  <i
                    className={`dropdown-icon ${
                      state.activeMenu === "page" ? "bi bi-dash" : "bi bi-plus"
                    }`}
                    onClick={() => collapseMenu("page")}
                  />
                  <ul
                    className={`sub-menu ${
                      state.activeMenu === "page" ? "d-block" : ""
                    }`}
                  >
                    <li className={pathName==="/car-auction/about"?"active":""}>
                      <Link href="/car-auction/about">About</Link>
                    </li>
                    <li className={pathName==="/car-auction/category"?"active":""}>
                      <Link href="/car-auction/category">Category</Link>
                    </li>
                    <li className={pathName==="/car-auction/store-list"?"active":""}>
                      <Link href="/car-auction/store-list">Seller</Link>
                      <i
                      ...
                      <ul
                        className={`sub-menu ${
                          state.activeSubMenu === "seller"
                            ? "d-block"
                            : ""
                        }`}
                      >
                        <li className={pathName==="/car-auction/store-list"?"active":""}>
                          <Link href="/car-auction/store-list">Seller List</Link>
                        </li>
                        <li className={pathName==="/car-auction/sote-details"?"active":""}>
                          <Link href="/car-auction/store-details">Seller Details</Link>
                        </li>
                      </ul>
                    </li>
                    <li className={pathName==="/car-auction/how-to-sell"?"active":""}>
                      <Link href="/car-auction/how-to-sell">How To Sell</Link>
                    </li>
                    <li className={pathName==="/car-auction/how-to-buy"?"active":""}>
                      <Link href="/car-auction/how-to-buy">How to Bid</Link>
                    </li>
                    <li className={pathName==="/car-auction/dashboard"?"active":""}>
                      <Link href="/car-auction/dashboard">Dashbaord</Link>
                    </li>
                    <li className={pathName==="/car-auction/faq"?"active":""}>
                      <Link href="/car-auction/faq">Faqs</Link>
                    </li>
                    <li className={pathName==="/car-auction/error"?"active":""}>
                      <Link href="/car-auction/error">Error</Link>
                    </li>
                  </ul>
                </li>
                <li className={pathName==="/car-auction/contact"?"active":""}>
