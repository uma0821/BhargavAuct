          ...
          <div className="row align-items-center">
            <div className="col-lg-6">
              <div className="section-title2 mb-50">
                ...
                <h2>Praise from Our <span>Clients.</span></h2>
              </div>
            ...
            <div className="col-lg-6 d-flex justify-content-end wow animate fadeInRight" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="testimonial-img-area">
                <img src="../assets/img/home3/testimonial-grp-img.png" alt="" />
              </div>
            </div>
          </div>
        </div>
