...
const Home6AuctionSpotlight = () => {
  const { days, hours, minutes, seconds } = useCountdownTimer("2024-10-23 12:00:00")
  return (
    <>
      <div className="home6-auction-spotlight-section mb-110">
        <div className="container">
          <div className="row mb-60 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
            <div className="col-lg-12 d-flex align-items-center justify-content-between flex-wrap gap-3">
              ...
              <Link className="view-button2 three" href="//book-and-comic/auction-grid">
                View All Auction
                <div className="arrow">
          ...
          <div className="row g-4">
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link href="/book-and-comic/auction-details" className="card-img">
                    <img src="../assets/img/home6/auction-img1.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">John revere draw First Edition Masterpiece.</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,898</strong>
                    </div>
                    <Link href="/book-and-comic/auction-details" className="bid-btn">
                      Bid Now
                    </Link>
                  </div>
                </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link href="/book-and-comic/auction-details" className="card-img">
                    <img src="../assets/img/home6/auction-img2.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">Literary Gem First Edition of Drawing Near.</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,560</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">Rare Find Signed Copy of Before Amen.</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,356</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link href="/book-and-comic/auction-details" className="card-img">
                    <img src="../assets/img/home6/auction-img4.jpg" alt="" />
                  </Link>
                  <div className="batch">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">Collector's Edition Limited Print of Frank Perel.</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,289</strong>
                    </div>
                    <Link href="/book-and-comic/auction-details2" className="bid-btn">
                      Notify Me
                    </Link>
                  </div>
                </div>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="800ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link href="/book-and-comic/auction-details" className="card-img">
                    <img src="../assets/img/home6/auction-img5.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">Historical Treasure Antique Thinking Fast &amp; Slow</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,689</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="600ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link href="/book-and-comic/auction-details" className="card-img">
                    <img src="../assets/img/home6/auction-img6.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">Illustrate Masterpiece Deluxe Edition of Love skip.</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,855</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="400ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link href="/book-and-comic/auction-details" className="card-img">
                    <img src="../assets/img/home6/auction-img7.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="upcoming">
                      <svg width={9} height={9} viewBox="0 0 9 9" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">Vintag Classic Leather bound God’s leading lady.</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$8,974</strong>
            ...
            <div className="col-xl-3 col-lg-4 col-md-6 wow animate fadeInDown" data-wow-delay="200ms" data-wow-duration="1500ms">
              <div className="auction-card style-6">
                <div className="auction-card-img-wrap">
                  <Link href="/book-and-comic/auction-details" className="card-img">
                    <img src="../assets/img/home6/auction-img8.jpg" alt="" />
                  </Link>
                  <div className="batch">
                    <span className="live">
                      <svg width={11} height={11} viewBox="0 0 11 11" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="auction-card-content">
                  <h6><Link href="/book-and-comic/auction-details">Modern Rariti First Printing of Alex rider by Munby.</Link></h6>
                  <div className="price-and-code-area">
                    <div className="price">
                      <span>Current Bid at:</span>
                      <strong>$2,855</strong>
...
export default Home6AuctionSpotlight
