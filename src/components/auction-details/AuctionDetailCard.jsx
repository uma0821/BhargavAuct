...
const AuctionDetailCard = React.memo(({ lot }) => {
  // console.log("=====lot==AuctionDetailCard==", lot);
  return (
    <SwiperSlide className="swiper-slide">
      <div className="auction-card">
        <div className="auction-card-img-wrap">
          <Link href={`/auction-details/${lot.lot_id}`} className="card-img">
            <img src={`/${lot?.lot_front_img}`} alt="" />
          </Link>
          <div className="batch">
            <span className="live">
              <svg
        ...
        <div className="auction-card-content">
          <h6>
            <Link href={`/auction-details/${lot.lot_id}`}>
              {lot.lot_description.split("").slice(0, 50).join("")}...
            </Link>
          </h6>
