                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-4">
                        <div className="auction-card-img-wrap">
                          ...
                          >
                            <img
                              src="../assets/img/home4/auction-img4.jpg"
                              alt=""
                            />
                          </Link>
                          <div className="batch">
                        ...
                        <div className="auction-card-content">
                          <h6>
                            <Link href="/art-auction/auction-details">
                              Artistry in Auction Celebratin Creative
                              Excellence.
                            </Link>
                          </h6>
                          <div className="price-and-code-area">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-4">
                        <div className="auction-card-img-wrap">
                          ...
                          >
                            <img
                              src="../assets/img/home4/auction-img5.jpg"
                              alt=""
                            />
                          </Link>
                          <div className="batch">
                        ...
                        <div className="auction-card-content">
                          <h6>
                            <Link href="/art-auction/auction-details">
                              Auction of Elegance Fine Art and Antiques.
                            </Link>
                          </h6>
                          <div className="price-and-code-area">
                            <div className="price">
                    ...
                    <SwiperSlide className="swiper-slide">
                      <div className="auction-card style-4">
                        <div className="auction-card-img-wrap">
                          ...
                          >
                            <img
                              src="../assets/img/home4/auction-img6.jpg"
                              alt=""
                            />
                          </Link>
                          <div className="batch">
                        ...
                        <div className="auction-card-content">
                          <h6>
                            <Link href="/art-auction/auction-details">
                              Art &amp; Bidding Contemporary Auction.
                            </Link>
                          </h6>
                          <div className="price-and-code-area">
                            <div className="price">
...
export default ArtAuctionDetails1