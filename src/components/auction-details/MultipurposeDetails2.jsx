                                                                ...
                                                                <div className="auction-card-content">
                                                                    <h6>
                                                                        <Link href="/auction-details">
                                                                            Zenith auto elevating driving your
                                                                            experience
                                                                        </Link>
                                                                    </h6>
                                                        ...
                                                        <SwiperSlide className="swiper-slide">
                                                            <div className="auction-card">
                                                                ...
                                                                <div className="auction-card-content">
                                                                    <h6>
                                                                        <Link href="/auction-details">
                                                                            Heritage had curating watch time
                                                                            treasures.
                                                                        </Link>
                                                                    </h6>
                                                                    <div className="price-and-code-area">
                                                        ...
                                                        <SwiperSlide className="swiper-slide">
                                                            <div className="auction-card">
                                                                ...
                                                                <div className="auction-card-content">
                                                                    <h6>
                                                                        <Link href="/auction-details">
                                                                            Canvas code redefining art in the digital
                                                                            realm.
                                                                        </Link>
                                                                    </h6>
                                                                    <div className="price-and-code-area">
                                                        ...
                                                        <SwiperSlide className="swiper-slide">
                                                            <div className="auction-card">
                                                                ...
                                                                <div className="auction-card-content">
                                                                    <h6>
                                                                        <Link href="/auction-details">
                                                                            Nomism on nexus connecting collectors to
                                                                            coins.
                                                                        </Link>
                                                                    </h6>
                                                                    <div className="price-and-code-area">
                                                        ...
                                                        <SwiperSlide className="swiper-slide">
                                                            <div className="auction-card">
                                                                ...
                                                                <div className="auction-card-content">
                                                                    <h6>
                                                                        <Link href="/auction-details">
                                                                            Vintage valor embracing then elegance of
                                                                            eras past.
                                                                        </Link>
                                                                    </h6>
                                                                    <div className="price-and-code-area">
                                                        ...
                                                        <SwiperSlide className="swiper-slide">
                                                            <div className="auction-card">
                                                                ...
                                                                <div className="auction-card-content">
                                                                    <h6>
                                                                        <Link href="/auction-details">
                                                                            Nostalgian hookup memories reside in every
                                                                            piece.
                                                                        </Link>
                                                                    </h6>
                                                                    <div className="price-and-code-area">
