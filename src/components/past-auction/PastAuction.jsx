...
const PastAuction = () => {
  ...
  const { data: closedAuctions,loading, error } = useSelector((state) => state.tablesData.allauctions);
  ...
  // const totalResults = lotData.length;
            ...
            {closedAuctions['data'] ? (
              <>
                <div className="row g-4 mb-60">
                  { ! loading ? closedAuctions.data
                      .map((auct) => {
                        if(auct.auct_status === 'COMPLETED') {
                          return (
                            <div
                            ...
                            >
                              <div className="auction-card">
                                  ...
                                  <Link
                                    href={
                                      Boolean(localStorage.getItem("token"))
                                        ? `/past-auction/${auct.auct_id}`
                                        : "/login"
                                    }
                                    className="card-img"
                                  >
                                    <img src={auct.image_address} alt="" height='237px'/>
                                  </Link>
                                  <div className="batch">
                                    {/* <span className="live"> */}
                                    <span className={auct?.auct_status.toLowerCase()}>
                                      <svg
                                        width={11}
                                        height={11}
                                        viewBox="0 0 11 11"
                                ...
                                <div className="auction-card-content">
                                  ...
                                  <div className="price">
                                      <span>End Date: </span>
                                      <strong>{getReadableDate(auct?.end_date)}</strong>
                                    </div>
                                    <div className="code">
