        ...
        <div className="container">
                ...
                <div className="footer-widget">
                  ...
                  <div className="menu-container">
                    <ul className="widget-list">
                      <li>
                        <Link href="/book-and-comic/auction-grid">Comics</Link>
                      </li>
                      <li>
                        <Link href="/book-and-comic/auction-grid">History</Link>
                      </li>
                      <li>
                      ...
                      <li>
                        <Link href="/book-and-comic/auction-grid">Horror</Link>
                      </li>
                      <li>
                        <Link href="/book-and-comic/auction-grid">
                          Children's
          ...
          <div className="footer-bottom">
            ...
            <div className="footer-bottom-right">
              <ul>
                <li>
                  <Link href="/book-and-comic/support-center">
                    Support Center
                  </Link>
                </li>
                <li>
                  <Link href="/book-and-comic/terms-condition">
                    Terms &amp; Conditions
                  </Link>
                </li>
                <li>
                  <Link href="/book-and-comic/privacy-policy">
                    Privacy Policy
                  </Link>
                </li>
              </ul>
